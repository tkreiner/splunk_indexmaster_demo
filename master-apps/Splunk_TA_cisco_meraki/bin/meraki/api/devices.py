...
class Devices(object):
    ...
    def getDevice(self, serial: str):
        ...
        **Return a single device**
        ...
        metadata = {"tags": ["devices", "configure"], "operation": "getDevice"}
    ...
    def blinkDeviceLeds(self, serial: str, **kwargs):
        ...
        **Blink the LEDs on a device**
        ...
        metadata = {"tags": ["devices", "liveTools"], "operation": "blinkDeviceLeds"}
        serial = urllib.parse.quote(str(serial), safe="")
    ...
    def rebootDevice(self, serial: str):
        ...
        **Reboot a device**
        ...
        metadata = {"tags": ["devices", "liveTools"], "operation": "rebootDevice"}
        serial = urllib.parse.quote(str(serial), safe="")
