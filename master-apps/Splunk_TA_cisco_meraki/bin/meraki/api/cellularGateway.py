...
class CellularGateway(object):
    ...
    def getNetworkCellularGatewayConnectivityMonitoringDestinations(
        self, networkId: str
    ):
        """
        **Return the connectivity testing destinations for an MG network**
        ...
        resource = (
            f"/networks/{networkId}/cellularGateway/connectivityMonitoringDestinations"
        )
    ...
    def getOrganizationCellularGatewayUplinkStatuses(
