...
class Switch(object):
    ...
    def updateDeviceSwitchPort(self, serial: str, portId: str, **kwargs):
        ...
        **Update a switch port**
        ...
        if "accessPolicyType" in kwargs:
            ...
            assert (
                kwargs["accessPolicyType"] in options
    ...
    def createDeviceSwitchRoutingInterface(self, serial: str, **kwargs):
        ...
        **Create a layer 3 interface for a switch**
        ...
        if "multicastRouting" in kwargs:
            ...
            assert (
                kwargs["multicastRouting"] in options
    ...
    def updateDeviceSwitchRoutingInterface(
        self, serial: str, interfaceId: str, **kwargs
    ):
        """
    ...
    def updateDeviceSwitchRoutingInterfaceDhcp(
        self, serial: str, interfaceId: str, **kwargs
    ):
        """
        ...
        if "dnsNameserversOption" in kwargs:
            ...
            assert (
                kwargs["dnsNameserversOption"] in options
    ...
    def updateDeviceSwitchRoutingStaticRoute(
        self, serial: str, staticRouteId: str, **kwargs
    ):
        """
    ...
    def updateNetworkSwitchAccessPolicy(
    ...
    def createNetworkSwitchRoutingMulticastRendezvousPoint(
        self, networkId: str, interfaceIp: str, multicastGroup: str
    ):
        """
    ...
    def getNetworkSwitchStackRoutingInterfaces(
        ...
        **List layer 3 interfaces for a switch stack**
        ...
        switchStackId = urllib.parse.quote(str(switchStackId), safe="")
        resource = (
            f"/networks/{networkId}/switch/stacks/{switchStackId}/routing/interfaces"
        )

        return self._session.get(metadata, resource)

    def createNetworkSwitchStackRoutingInterface(
        self, networkId: str, switchStackId: str, name: str, vlanId: int, **kwargs
    ):
        """
    ...
    def getNetworkSwitchStackRoutingStaticRoutes(
        self, networkId: str, switchStackId: str
    ):
        """
        **List layer 3 static routes for a switch stack**
        ...
        switchStackId = urllib.parse.quote(str(switchStackId), safe="")
        resource = (
            f"/networks/{networkId}/switch/stacks/{switchStackId}/routing/staticRoutes"
        )
