...
class Networks(object):
    ...
    def getNetwork(self, networkId: str):
        ...
        **Return a network**
        ...
        metadata = {"tags": ["networks", "configure"], "operation": "getNetwork"}
    ...
    def provisionNetworkClients(
        self, networkId: str, clients: list, devicePolicy: str, **kwargs
    ):
        """
        **Provisions a client with a name and policy**
        ...
        if "devicePolicy" in kwargs:
            ...
            assert (
                kwargs["devicePolicy"] in options
    ...
    def createNetworkFirmwareUpgradesRollback(
        self, networkId: str, reasons: list, **kwargs
    ):
        """
    ...
    def createNetworkFirmwareUpgradesStagedEvent(
    ...
    def rollbacksNetworkFirmwareUpgradesStagedEvents(
        self, networkId: str, stages: list, **kwargs
    ):
        """
    ...
    def deleteNetworkMerakiAuthUser(
        self, networkId: str, merakiAuthUserId: str, **kwargs
    ):
        """
    ...
    def updateNetworkMerakiAuthUser(
        self, networkId: str, merakiAuthUserId: str, **kwargs
    ):
        """
    ...
    def createNetworkMqttBroker(
        self, networkId: str, name: str, host: str, port: int, **kwargs
    ):
        """
        **Add an MQTT broker**
    ...
    def getNetworkPoliciesByClient(
        self, networkId: str, total_pages=1, direction="next", **kwargs
    ):
        """
    ...
    def createNetworkWebhooksHttpServer(
    ...
    def updateNetworkWebhooksHttpServer(
        self, networkId: str, httpServerId: str, **kwargs
    ):
        """
    ...
    def getNetworkWebhooksPayloadTemplate(self, networkId: str, payloadTemplateId: str):
        ...
        **Get the webhook payload template for a network**
        ...
        resource = (
            f"/networks/{networkId}/webhooks/payloadTemplates/{payloadTemplateId}"
        )

        return self._session.get(metadata, resource)

    def deleteNetworkWebhooksPayloadTemplate(
