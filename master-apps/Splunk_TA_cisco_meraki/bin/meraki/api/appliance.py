#
# SPDX-FileCopyrightText: 2020 Meraki Cisco <api-feedback@meraki.net>
...
class Appliance(object):
    ...
    def updateNetworkApplianceConnectivityMonitoringDestinations(
    ...
    def updateNetworkApplianceContentFiltering(self, networkId: str, **kwargs):
        ...
        **Update the content filtering settings for an MX network**
        ...
        if "urlCategoryListSize" in kwargs:
            ...
            assert (
                kwargs["urlCategoryListSize"] in options
    ...
    def updateNetworkApplianceFirewallCellularFirewallRules(
        self, networkId: str, **kwargs
    ):
        """
    ...
    def getNetworkApplianceFirewallFirewalledService(
        ...
        **Return the accessibility settings of the given service ('ICMP', 'web', or 'SNMP')**
        ...
        resource = (
            f"/networks/{networkId}/appliance/firewall/firewalledServices/{service}"
        )
    ...
    def getNetworkApplianceFirewallInboundCellularFirewallRules(self, networkId: str):
        ...
        **Return the inbound cellular firewall rules for an MX network**
        ...
        networkId = urllib.parse.quote(str(networkId), safe="")
        resource = (
            f"/networks/{networkId}/appliance/firewall/inboundCellularFirewallRules"
        )

        return self._session.get(metadata, resource)

    def updateNetworkApplianceFirewallInboundCellularFirewallRules(
        self, networkId: str, **kwargs
    ):
        """
    ...
    def getNetworkApplianceFirewallL7FirewallRulesApplicationCategories(
        self, networkId: str
    ):
        """
    ...
    def updateNetworkApplianceFirewallOneToManyNatRules(
    ...
    def updateNetworkApplianceFirewallOneToOneNatRules(
        self, networkId: str, rules: list
    ):
        """
    ...
    def updateNetworkApplianceFirewallPortForwardingRules(
        self, networkId: str, rules: list
    ):
        """
    ...
    def getNetworkAppliancePrefixesDelegatedStatic(
        ...
        **Return a static delegated prefix from a network**
        ...
        networkId = urllib.parse.quote(str(networkId), safe="")
        staticDelegatedPrefixId = urllib.parse.quote(
            str(staticDelegatedPrefixId), safe=""
        )
    ...
    def updateNetworkApplianceRfProfile(
    ...
    def updateNetworkApplianceSecurityMalware(
        self, networkId: str, mode: str, **kwargs
    ):
        """
    ...
    def updateNetworkApplianceSettings(self, networkId: str, **kwargs):
        ...
        **Update the appliance settings for a network**
        ...
        if "clientTrackingMethod" in kwargs:
            ...
            assert (
                kwargs["clientTrackingMethod"] in options
        ...
        if "deploymentMode" in kwargs:
            ...
            assert (
                kwargs["deploymentMode"] in options
    ...
    def updateNetworkApplianceStaticRoute(
        self, networkId: str, staticRouteId: str, **kwargs
    ):
        """
    ...
    def getNetworkApplianceTrafficShapingCustomPerformanceClasses(self, networkId: str):
        ...
        **List all custom performance classes for an MX network**
        ...
        networkId = urllib.parse.quote(str(networkId), safe="")
        resource = (
            f"/networks/{networkId}/appliance/trafficShaping/customPerformanceClasses"
        )
    ...
    def getNetworkApplianceTrafficShapingCustomPerformanceClass(
        ...
        **Return a custom performance class for an MX network**
        ...
        networkId = urllib.parse.quote(str(networkId), safe="")
        customPerformanceClassId = urllib.parse.quote(
            str(customPerformanceClassId), safe=""
        )
    ...
    def updateNetworkApplianceTrafficShapingUplinkBandwidth(
        self, networkId: str, **kwargs
    ):
        """
    ...
    def updateNetworkApplianceTrafficShapingUplinkSelection(
        self, networkId: str, **kwargs
    ):
        """
        **Update uplink selection settings for an MX network**
        ...
        if "defaultUplink" in kwargs:
            options = ["wan1", "wan2"]
            assert (
                kwargs["defaultUplink"] in options
            ), f""""defaultUplink" cannot be "{kwargs['defaultUplink']}", & must be set to one of: {options}"""
    ...
    def updateNetworkApplianceTrafficShapingVpnExclusions(
        self, networkId: str, **kwargs
    ):
        """
    ...
    def createNetworkApplianceVlan(self, networkId: str, id: str, name: str, **kwargs):
        ...
        **Add a VLAN**
        ...
        if "templateVlanType" in kwargs:
            options = ["same", "unique"]
            assert (
                kwargs["templateVlanType"] in options
    ...
    def updateNetworkApplianceVpnSiteToSiteVpn(
        self, networkId: str, mode: str, **kwargs
    ):
        """
    ...
    def updateOrganizationApplianceSecurityIntrusion(
    ...
    def updateOrganizationApplianceVpnThirdPartyVPNPeers(
    ...
    def updateOrganizationApplianceVpnVpnFirewallRules(
        self, organizationId: str, **kwargs
    ):
        """
