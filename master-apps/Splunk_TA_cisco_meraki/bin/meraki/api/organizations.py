...
class Organizations(object):
    ...
    def updateOrganizationAdaptivePolicyAcl(
        self, organizationId: str, aclId: str, **kwargs
    ):
        """
    ...
    def updateOrganizationAdaptivePolicyGroup(
    ...
    def createOrganizationAdaptivePolicyPolicy(
        ...
        **Add an Adaptive Policy**
        ...
        if "lastEntryRule" in kwargs:
            ...
            assert (
                kwargs["lastEntryRule"] in options
    ...
    def updateOrganizationAdaptivePolicyPolicy(
        self, organizationId: str, id: str, **kwargs
    ):
        """
    ...
    def createOrganizationAdmin(
        ...
        **Create a new dashboard administrator**
        ...
        if "authenticationMethod" in kwargs:
            ...
            assert (
                kwargs["authenticationMethod"] in options
    ...
    def updateOrganizationAlertsProfile(
        self, organizationId: str, alertConfigId: str, **kwargs
    ):
        """
    ...
    def getOrganizationClientsBandwidthUsageHistory(
        self, organizationId: str, **kwargs
    ):
        """
    ...
    def createOrganizationConfigTemplate(
        self, organizationId: str, name: str, **kwargs
    ):
        """
    ...
    def getOrganizationDevices(
        ...
        **List the devices in an organization**
        ...
        if "tagsFilterType" in kwargs:
            ...
            assert (
                kwargs["tagsFilterType"] in options
    ...
    def getOrganizationDevicesAvailabilitiesChangeHistory(
        ...
        **List the availability history information for devices in an organization.**
        ...
        organizationId = urllib.parse.quote(str(organizationId), safe="")
        resource = (
            f"/organizations/{organizationId}/devices/availabilities/changeHistory"
        )
    ...
    def getOrganizationDevicesPowerModulesStatusesByDevice(
        ...
        **List the most recent status information for power modules in rackmount MX and MS devices that support them**
        ...
        organizationId = urllib.parse.quote(str(organizationId), safe="")
        resource = (
            f"/organizations/{organizationId}/devices/powerModules/statuses/byDevice"
        )
    ...
    def getOrganizationDevicesUplinksLossAndLatency(
        self, organizationId: str, **kwargs
    ):
        """
    ...
    def getOrganizationEarlyAccessFeaturesOptIn(
        ...
        **Show an early access feature opt-in for an organization**
        ...
        resource = (
            f"/organizations/{organizationId}/earlyAccess/features/optIns/{optInId}"
        )
    ...
    def deleteOrganizationEarlyAccessFeaturesOptIn(
        self, organizationId: str, optInId: str
    ):
        """
    ...
    def createOrganizationPolicyObjectsGroup(
        self, organizationId: str, name: str, **kwargs
    ):
        """
    ...
    def getOrganizationPolicyObjectsGroup(
    ...
    def deleteOrganizationPolicyObjectsGroup(
        self, organizationId: str, policyObjectGroupId: str
    ):
        """
    ...
    def updateOrganizationPolicyObject(
        self, organizationId: str, policyObjectId: str, **kwargs
    ):
        """
    ...
    def createOrganizationSamlRole(
    ...
    def getOrganizationSummaryTopAppliancesByUtilization(
        self, organizationId: str, **kwargs
    ):
        """
        **Return the top 10 appliances sorted by utilization over given time range.**
        ...
        organizationId = urllib.parse.quote(str(organizationId), safe="")
        resource = (
            f"/organizations/{organizationId}/summary/top/appliances/byUtilization"
        )
    ...
    def getOrganizationSummaryTopClientsManufacturersByUsage(
        self, organizationId: str, **kwargs
    ):
        """
        **Return metrics for organization's top clients by data usage (in mb) over given time range, grouped by manufacturer.**
        ...
        organizationId = urllib.parse.quote(str(organizationId), safe="")
        resource = (
            f"/organizations/{organizationId}/summary/top/clients/manufacturers/byUsage"
        )
    ...
    def getOrganizationSummaryTopDevicesModelsByUsage(
        self, organizationId: str, **kwargs
    ):
        """
    ...
    def getOrganizationSummaryTopSwitchesByEnergyUsage(
        self, organizationId: str, **kwargs
    ):
        """
