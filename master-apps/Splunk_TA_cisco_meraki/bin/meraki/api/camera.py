...
class Camera(object):
    ...
    def updateDeviceCameraQualityAndRetention(self, serial: str, **kwargs):
        ...
        **Update quality and retention settings for the given camera**
        ...
        if "motionDetectorVersion" in kwargs:
            options = [1, 2]
            assert (
                kwargs["motionDetectorVersion"] in options
    ...
    def getNetworkCameraQualityRetentionProfile(
        ...
        **Retrieve a single quality retention profile**
        ...
        networkId = urllib.parse.quote(str(networkId), safe="")
        qualityRetentionProfileId = urllib.parse.quote(
            str(qualityRetentionProfileId), safe=""
        )
    ...
    def createNetworkCameraWirelessProfile(
    ...
    def updateNetworkCameraWirelessProfile(
    ...
    def deleteNetworkCameraWirelessProfile(
    ...
    def createOrganizationCameraCustomAnalyticsArtifact(
    ...
    def getOrganizationCameraCustomAnalyticsArtifact(
    ...
    def deleteOrganizationCameraCustomAnalyticsArtifact(
        self, organizationId: str, artifactId: str
    ):
        """
    ...
    def getOrganizationCameraPermission(
        ...
        **Retrieve a single permission scope**
        ...
        resource = (
            f"/organizations/{organizationId}/camera/permissions/{permissionScopeId}"
        )
