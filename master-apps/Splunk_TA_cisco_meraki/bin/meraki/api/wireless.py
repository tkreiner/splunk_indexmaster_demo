...
class Wireless(object):
    ...
    def updateDeviceWirelessAlternateManagementInterfaceIpv6(
    ...
    def updateNetworkWirelessAlternateManagementInterface(
    ...
    def getNetworkWirelessClientConnectionStats(
    ...
    def getNetworkWirelessClientConnectivityEvents(
        ...
        **List the wireless connectivity events for a client within a network in the timespan.**
        ...
        clientId = urllib.parse.quote(str(clientId), safe="")
        resource = (
            f"/networks/{networkId}/wireless/clients/{clientId}/connectivityEvents"
        )
    ...
    def getNetworkWirelessClientLatencyHistory(
        self, networkId: str, clientId: str, **kwargs
    ):
        """
    ...
    def getNetworkWirelessClientLatencyStats(
        self, networkId: str, clientId: str, **kwargs
    ):
        """
    ...
    def setNetworkWirelessEthernetPortsProfilesDefault(
    ...
    def updateNetworkWirelessEthernetPortsProfile(
    ...
    def getNetworkWirelessLatencyHistory(self, networkId: str, **kwargs):
        ...
        **Return average wireless latency over time for a network, device, or network client**
        ...
        if "accessCategory" in kwargs:
            ...
            assert (
                kwargs["accessCategory"] in options
    ...
    def updateNetworkWirelessSettings(self, networkId: str, **kwargs):
        ...
        **Update the wireless settings for a network**
        ...
        if "upgradeStrategy" in kwargs:
            ...
            assert (
                kwargs["upgradeStrategy"] in options
    ...
    def updateNetworkWirelessSsid(self, networkId: str, number: str, **kwargs):
        ...
        **Update the attributes of an MR SSID**
        ...
        if "radiusAttributeForGroupPolicies" in kwargs:
            ...
            assert (
                kwargs["radiusAttributeForGroupPolicies"] in options
    ...
    def updateNetworkWirelessSsidBonjourForwarding(
    ...
    def getNetworkWirelessSsidDeviceTypeGroupPolicies(
        ...
        **List the device type group policies for the SSID**
        ...
        number = urllib.parse.quote(str(number), safe="")
        resource = (
            f"/networks/{networkId}/wireless/ssids/{number}/deviceTypeGroupPolicies"
        )
    ...
    def updateNetworkWirelessSsidEapOverride(
        self, networkId: str, number: str, **kwargs
    ):
        """
    ...
    def getNetworkWirelessSsidFirewallL3FirewallRules(
        self, networkId: str, number: str
    ):
        """
        **Return the L3 firewall rules for an SSID on an MR network**
        ...
        number = urllib.parse.quote(str(number), safe="")
        resource = (
            f"/networks/{networkId}/wireless/ssids/{number}/firewall/l3FirewallRules"
        )
    ...
    def getNetworkWirelessSsidFirewallL7FirewallRules(
        self, networkId: str, number: str
    ):
        """
        **Return the L7 firewall rules for an SSID on an MR network**
        ...
        number = urllib.parse.quote(str(number), safe="")
        resource = (
            f"/networks/{networkId}/wireless/ssids/{number}/firewall/l7FirewallRules"
        )
    ...
    def updateNetworkWirelessSsidHotspot20(self, networkId: str, number: str, **kwargs):
        ...
        **Update the Hotspot 2.0 settings of an SSID**
        ...
        if "networkAccessType" in kwargs:
            ...
            assert (
                kwargs["networkAccessType"] in options
    ...
    def getNetworkWirelessSsidIdentityPsk(
    ...
    def deleteNetworkWirelessSsidIdentityPsk(
        self, networkId: str, number: str, identityPskId: str
    ):
        """
    ...
    def updateNetworkWirelessSsidSplashSettings(
        self, networkId: str, number: str, **kwargs
    ):
        """
        **Modify the splash page settings for the given SSID**
        ...
        if "controllerDisconnectionBehavior" in kwargs:
            ...
            assert (
                kwargs["controllerDisconnectionBehavior"] in options
    ...
    def updateNetworkWirelessSsidTrafficShapingRules(
        self, networkId: str, number: str, **kwargs
    ):
        """
