...
class Sm(object):
    ...
    def updateNetworkSmDevicesFields(
    ...
    def modifyNetworkSmDevicesTags(
    ...
    def installNetworkSmDeviceApps(
        self, networkId: str, deviceId: str, appIds: list, **kwargs
    ):
        """
